...
1. Obtener información relevante
    - Precios, servicios, geolocalización
2. Caracterizar los hoteles
    - Categorías de servicios equivalentes
3. Diseñar un criterio integral de similitud
    - Precio
    - Mismos servicios (categoría similar)
    - Perfil similar
    - Cercanía
...
- Mala calidad
- Problemas con EAN
- Se está trabajando en mejorarla
...
- La base de servicios está sucia
    + Se está trabajando en hoteles EAN
