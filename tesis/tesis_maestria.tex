...
\begin{itemize}
	...
	\item \emph{Diámetro:} El diámetro de una gráfica conexa es la distancia máxima entre cualesquiera dos nodos de la gráfica. Nuevamente, en las gráficas dirigidas se debe respetar la dirección de los arcos.
	\item \emph{Grados:}
	\begin{itemize}
