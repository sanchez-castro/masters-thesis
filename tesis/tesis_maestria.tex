...
\newglossaryentry{sp}{
	...
	description={Procedimiento almacenado físicamente en una base de datos que se ejecuta directamente en el motor de bases de datos facilitando la integración de sistemas}
}
\newglossaryentry{sql}{
