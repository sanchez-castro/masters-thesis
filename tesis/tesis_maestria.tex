...
\begin{figure}[ht]
\centering
%%% Mejorar esta gráfica (checar título)
\includegraphics[width=\textwidth]{imagenes/simserv.png}
\caption{\label{simserv} Ejemplos de similitud de servicios para 4 categorías distintas. El hotel verde se parece al negro porque no le faltan muchos servicios que el negro sí tiene. En contraste, al hotel rojo le faltan muchos servicios.}
\end{figure}
