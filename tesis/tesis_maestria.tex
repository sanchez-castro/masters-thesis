...
En la figura (\ref{fig:flujo}) mostramos el diagrama de flujo del sistema ideal. Desafortunadamente, en la vida real hubo algunas restricciones para la implementación


NO ALMACENAMOS TODAS LAS RECOMENDACIONES, SINO SOLO UNAS POCAS.
